...
import { getimmunizationdata,addimmunizationdata,addotherimmunizationdata} from "../../../redux/actions/common-action-creator";
...
function Immunization({ImmunizationData,addimmunizationdata,getimmunizationdata,addotherimmunizationdata,props}) {
            ...
            body = JSON.stringify({ userId:id, covid: {...body,userId:id,UpdatedDate:new Date()}})
          ...
          const SubmitVaccineDetails = (event) => {
            ...
            body = JSON.stringify({ userId:id, others: {...body,userId:id,UpdatedDate:new Date()} })
            addotherimmunizationdata(body);
            handleOpen();
          };
  ...
  const [addFormValue,setFormValue] = React.useState({});
    ...
    getimmunizationdata(id);
        ...
        setvaccine(prevState => ({
            ...prevState,...immunizationformdata[1]?.others
        }))
        }
  ...
  console.log("covid",addFormValue);
  console.log(immunizationformdata);
  console.log("others",othervaccine);
...
const mapStateToProps = (state) => {
  ...
  const mapdispatchToProps = (dispatch) => {
    return {
        ...
        addotherimmunizationdata: (data) => dispatch(addotherimmunizationdata(data)),
        getimmunizationdata: (data) => dispatch(getimmunizationdata(data)),
